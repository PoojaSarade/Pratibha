...
System.setProperty("webdriver.chrome.driver", "./drivers/chromedriver.exe");
		...
		driver.get("http://desktop-3im63i8:81/user/submit_tt.do");
		...
		//driver.findElement(By.name("formCustomerFaceLogo")).click();
		
		
		//perform Double Click
		
		WebElement target = driver.findElement(By.name("formCusomInterfaceLogo.logo"));
